...
export const Footer = () => (
  <section className="flex w-full flex-col bg-yellow-bright-01 px-4 py-12">
    <div className="container mx-auto">
      <div className="flex flex-col justify-between md:flex-row">
        <div className="flex flex-col">
          <div className="mb-8 flex items-start">
            <img src={logo} alt="Poklist Logo" className="h-10" />
          </div>
          <div className="mb-8 flex flex-col items-start gap-4">
            <a href="#" className="text-lg hover:underline">Press Contact</a>
          ...
          <div className="flex gap-4">
            <Button variant="white" size="icon" className="rounded-lg" asChild>
              <a href="#"><img src={instagramLogo} alt="Instagram" className="h-5 w-5" /></a>
            </Button>
            <Button variant="white" size="icon" className="rounded-lg" asChild>
              <a href="#"><img src={threadsLogo} alt="Threads" className="h-5 w-5" /></a>
            </Button>
          </div>
        </div>
