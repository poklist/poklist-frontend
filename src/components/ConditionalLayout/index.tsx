...
// 桌面版樣式包裹組件
import Background from '@/app/_layout/_components/Layout/Background';
import BottomNav from '@/app/_layout/_components/Layout/BottomNav';
import PromptText from '@/app/_layout/_components/Layout/PromptText';
