  ...
  return (
    <>
      {isOpen && (
        ...
        >
          <div
            className="fixed bottom-0 left-1/2 max-w-mobile-max -translate-x-1/2 rounded-t-lg bg-white md:bottom-auto md:left-auto md:right-4 md:top-4 md:w-[400px] md:max-w-mobile-max md:translate-x-0 md:rounded-lg"
