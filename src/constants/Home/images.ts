...
export const IMAGES = {
  avatar: {
    ...
    foodAndDrink: foodAndDrinkAvatar,
    travel: travelAvatar,
    culture: cultureAvatar,
    entertainment: entertainmentAvatar,
    personalGrowth: personalGrowthAvatar,
    techAndDigital: techAndDigitalAvatar,
    healthAndFitness: healthAndFitnessAvatar,
    other: otherAvatar,
  },
  list: {
    lifeStyle: {
      list1: lifeStyleList1,
      list2: lifeStyleList2,
      list3: lifeStyleList3,
    },
    foodAndDrink: {
      list1: foodAndDrinkList1,
      list2: foodAndDrinkList2,
      list3: foodAndDrinkList3,
    },
    culture: {
      list1: cultureList1,
      list2: cultureList2,
    ...
    entertainment: {
      list1: entertainmentList1,
      list2: entertainmentList2,
      list3: entertainmentList3,
    },
    techAndDigital: {
      list1: techAndDigitalList1,
      list2: techAndDigitalList2,
      list3: techAndDigitalList3,
    },
    personalGrowth: {
      list1: personalGrowthList1,
      list2: personalGrowthList2,
      list3: personalGrowthList3,
    },
    healthAndFitness: {
      list1: healthAndFitnessList1,
      list2: healthAndFitnessList2,
      list3: healthAndFitnessList3,
    },
    other: {
      list1: otherList1,
      list2: otherList2,
